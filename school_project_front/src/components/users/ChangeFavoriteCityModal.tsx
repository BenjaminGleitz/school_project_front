                            ...
                            <div className="filter-input">
                                <div className="country-filter">
                                    ...
                                    {errors.selectedCountry &&
                                        <div className="error-message">{errors.selectedCountry}</div>}
                                </div>
                                {selectedCountry && (
                                    <div className="city-filter">
                                        <select id="city" onChange={handleCityChange} value={selectedCityObj?.id || ""}
                                                required>
                                        ...
                                        {errors.selectedCity &&
                                            <div className="error-message">{errors.selectedCity}</div>}
                                    </div>
                                )}
